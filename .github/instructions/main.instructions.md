# microservices_civildiy - Development Instructions

> Agent OS Project Instructions
> **Project:** microservices_civildiy Project
> **Architecture:** python with docker traefik
> Primary Project Type: python
> Additional Types: docker traefik
> Name: microservices_civildiy
> Updated: $(date +"%Y-%m-%d")

## ⚠️ IMMEDIATE ACTION REQUIRED ⚠️

**STOP**: Before proceeding with ANY task, you MUST activate MCP workflow systems:
follow all instructions in @reference-docs/instructions/main.instructions.md (symlink) to set up:
- Context7 → Meilisearch trust scoring system
- Memento MCP knowledge graph system
- Memory-Keeper session management system 

## Project Context

This is a **python** project with additional technologies (docker traefik) using Agent OS structured development workflows.

### Environment
- **Implementation Directory:** ./microservices_civildiy
- **Primary Technology:** python
- **Additional Technologies:** docker traefik
...
<!-- This section should be customized based on your specific python and docker traefik requirements -->
...
3. **Standards Compliance**: Follow the python standards primarily, with guidance from additional technologies
...
4. **Standards:** Follow established patterns and conventions for python development
...
- **Product Requirements:** @.github/instructions/microservices_civildiy_prd.md (if applicable)
...
- Use memory-keeper with channel: microservices_civildiy
...
- **Memento Entity Prefix**: "microservices_civildiy-"  
- **Detected Tech Stack**: python + docker traefik (auto-detected from @reference-docs/)
- **Cross-Project Learning**: Enabled for similar python projects
...
**Custom Analysis Areas**:
  - python architecture analysis and best practices
  - Integration patterns for docker traefik
...
**Technology Standards**:
  - python with docker traefik integration
...
**Implementation Standards**:
  - Follow python patterns and conventions
...
2. **Technology Integration:**
   - Ensure proper integration between python and docker traefik
...
- Primary standards from `@/reference-docs/python/main.instructions.md` take precedence when building python features
